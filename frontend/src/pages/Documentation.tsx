...
const categories: CategoryDoc[] = [
  {
    ...
    tools: [
      { to: '/remove-background', label: 'Remove BG', description: "Supprime le fond d'une image (modèle U2Net, via rembg)." },
      ...
      { to: '/convert-image', label: 'Convertir', description: 'Change le format entre JPEG, PNG, WebP et AVIF.' },
